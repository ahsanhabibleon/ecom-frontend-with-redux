              ...
              <div>
                <h4>
                  ...
                  <span className={Styles.subtotal}>
                    $
                    {cartItems.reduce(
                      (a: number, c: ProductDataTypes) => a + c?.price * (c?.quantity || 0),
                      0
                    )}
                  </span>{' '}
                  <span className={Styles.total_quantity}>{totalItems} items</span>
                </h4>
                <Button
                  onClick={handleCheckout}
                  type="primary"
                  style={{ backgroundColor: '#faad14', borderColor: '#faad14', color: '#333' }}
                >
                  Proceed to Checkout
                </Button>
                <br />
